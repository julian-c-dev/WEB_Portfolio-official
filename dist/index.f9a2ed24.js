...
})({"lt4KU":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "ef31fb8ef9a2ed24";
"use strict";
...
window.addEventListener("scroll", ()=>{
    ...
    if (window.scrollY > 150 && colorTheme) navDesk.classList.add("darkShadow");
    else navDesk.classList.remove("darkShadow");
    if (window.scrollY > 150 && !colorTheme) navDesk.classList.add("lightShadow");
